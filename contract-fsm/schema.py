...
Four mappable primitives:
  OBLIGATION  — party MUST do X by deadline
  PENALTY     — money/consequence triggered by breach  (maps to Effect.PAYMENT + Rule.VIOLATION)
...
class Effect:
    ...
    payment_formula: Optional[str] = None
...
class ContractParams:
    parties: list[str]
    base_dates: dict[str, Optional[str]]
